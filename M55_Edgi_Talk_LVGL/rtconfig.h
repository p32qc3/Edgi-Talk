...
/* Edgi-Talk: COM5/uart2 must belong to CM33. CM55 is display-only by default. */
#define EDGI_M55_UART_CONSOLE 0
#define EDGI_M55_FINSH_SHELL 0
#define EDGI_WIFI_FLASH_PERSIST 1
...
#define PKG_FREERTOS_USING_MEMMANG
#define PKG_FREERTOS_USING_MEMMANG_HEAP4
#define PKG_USING_FREERTOS_WRAPPER_LATEST_VERSION
/* portable.h is included before FreeRTOS.h sets this; heap_4 needs HeapStats_t from portable.h */
#if defined(PKG_FREERTOS_USING_MEMMANG_HEAP4) || defined(PKG_FREERTOS_USING_MEMMANG_HEAP5)
...
/* ES8388/采音在 M33 独占 HW I2C0；M55 再注册 i2c0 会导致 M33 挂死、seq 停涨 */
...
#undef LVGL_USING_DEMOS
/* External Nor (SMIF) + FAL: WHD firmware/clm/nvram partitions; enables fal_init in mnt when DFS is used */
...
#define CY_WIFI_INIT_THREAD_STACK_SIZE 8192
...
#define CYBSP_OOB_INTR_PRIORITY 5
